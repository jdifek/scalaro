    ...
    <section className="py-24 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="relative flex items-end gap-2 pb-0">
                <div className="flex items-end gap-1.5">
                  {[40, 65, 45, 80, 55, 90, 70, 95].map((h, i) => (
                    <div
                      key={i}
                      className="w-5 rounded-t-sm bg-white/30 hover:bg-white/50 transition-colors"
          ...
          <div className="bg-white rounded-3xl border border-slate-100 overflow-hidden hover:shadow-2xl transition-shadow duration-500 group flex flex-col">
              ...
              <div className="relative space-y-2">
                ...
                <div className="flex gap-2">
                  <div className="bg-white/20 rounded-lg p-2 flex-1">
                    ...
                    <div className="h-4 bg-white/70 rounded w-1/2 font-bold text-xs flex items-center pl-1 text-white/80">
                      50K readers
                    </div>
                  </div>
                  <div className="bg-white/20 rounded-lg p-2 flex-1">
            ...
            <div className="p-8 flex flex-col flex-1">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <div className="text-[11px] font-bold text-emerald-500 uppercase tracking-widest">
                    Product 02
                  </div>
                  <h3 className="text-xl font-bold text-slate-900">
                    {t("platform.title")}
        ...
        <div className="mt-8 p-5 rounded-2xl bg-gradient-to-r from-indigo-900 to-slate-900 border border-indigo-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="px-2.5 py-1 bg-amber-500/20 border border-amber-500/30 rounded-lg text-amber-400 text-xs font-bold">
              Q3 2026
            </div>
            <div>
          ...
          <p className="text-sm text-slate-400 text-center sm:text-right">
            Existing clients get priority access & better rates.{" "}
            <a
