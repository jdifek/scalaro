...
const FALLBACK_POSTS = [
  {
    ...
    excerpt_en: "A step-by-step guide to launching your own branded affiliate program using white-label software. From technical setup to recruiting your first affiliates.",
    excerpt_ua: "Покроковий посібник із запуску власної брендованої афіліатної програми за допомогою white-label програмного забезпечення.",
  ...
  {
    id: "2",
    title_en: "Affiliate Fraud Prevention: The Complete 2025 Guide",
    title_ua: "Запобігання афіліатному фроду: Повний гід 2025",
    excerpt_en: "Learn how to identify, prevent, and handle affiliate fraud. From click fraud to cookie stuffing — and how enterprise-grade tools protect your budget.",
    excerpt_ua: "Дізнайтесь як виявляти, запобігати та боротись з афіліатним фродом. Від клікового фроду до cookie stuffing.",
  ...
  },
  {
    ...
    excerpt_en: "Why traditional CMS solutions like WordPress fall short for fintech content needs, and what purpose-built content platforms offer instead.",
    excerpt_ua: "Чому традиційні CMS рішення як WordPress не підходять для потреб фінтех контенту, і що натомість пропонують спеціалізовані контент платформи.",
                ...
                <article className="bg-white rounded-2xl border border-slate-100 overflow-hidden hover:border-indigo-200 hover:shadow-xl transition-all duration-300 h-full flex flex-col">
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    <p className="text-sm text-slate-600 leading-relaxed mb-4 flex-1">
                      {locale === "ua" ? (post.excerpt_ua || post.excerpt_en) : (post.excerpt_en || post.excerpt_ua)}
                    </p>
