...
export const metadata: Metadata = {
  ...
  description:
    "Real results from real businesses. See how Finoglyad and other companies scaled their business using Scalaro's white-label software.",
};

const timeline = [
  {
    date: "Q1 2023",
    event: "Finoglyad onboarded to Content Platform",
    type: "launch",
  },
  {
    date: "Q2 2023",
    event: "Custom Ukrainian SEO optimization deployed",
    type: "feature",
  },
  {
    date: "Q3 2023",
    event: "Traffic doubled to 20,000 monthly readers",
    type: "milestone",
  },
  {
    date: "Q4 2023",
    event: "Newsletter feature launched, 5,000 subscribers",
    type: "feature",
  },
  {
    date: "Q1 2024",
    event: "Reached 40,000 monthly readers",
    type: "milestone",
  },
  {
    date: "Q2 2024",
    event: "Monetization tools deployed, revenue 2x",
    type: "milestone",
  },
  {
    date: "2026",
    event: "50,000+ monthly readers, #1 finance portal",
    type: "milestone",
  },
];
        ...
        <section className="py-24 bg-gradient-to-b from-slate-50 to-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Real results from real businesses. See how our clients are growing
              with Scalaro.
            </p>
          </div>
        </section>
              ...
              <div className="grid lg:grid-cols-2 gap-0">
                <div className="p-10 lg:p-16">
                  <div className="flex items-center gap-3 mb-6">
                    <span className="px-3 py-1 bg-emerald-500/20 text-emerald-400 text-xs font-bold rounded-lg">
                      CASE STUDY
                    </span>
                    <span className="px-3 py-1 bg-white/10 text-slate-300 text-xs font-bold rounded-lg">
                      Content Platform
                    </span>
                  </div>
                  ...
                  <p className="text-slate-400 text-lg mb-6">
                    Ukraine's leading financial comparison portal scaled to
                    50,000+ monthly readers and became the #1 fintech media
                  ...
                  <div className="flex gap-3">
                    <a
                      ...
                      className="inline-flex items-center gap-2 px-5 py-2.5 bg-white text-slate-900 font-semibold rounded-xl text-sm hover:bg-slate-100 transition-all"
                    >
                      ...
                      {timeline.map((item, i) => (
                        <div key={i} className="flex gap-4">
                          <div className="flex flex-col items-center">
                            ...
                            ></div>
                            {i < timeline.length - 1 && (
                              <div className="w-0.5 h-8 bg-white/10 mt-1"></div>
                            )}
                          </div>
                          <div className="pb-4">
            ...
            <div className="space-y-8">
              <div className="bg-white rounded-2xl border border-slate-100 p-8">
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  Finoglyad started as a small financial comparison website in
                  Ukraine in 2022. By early 2023, they had outgrown their
                  initial CMS and needed a platform that could:
                </p>
              ...
              <div className="bg-white rounded-2xl border border-slate-100 p-8">
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  Scalaro deployed a custom instance of the Content Platform in
                  March 2023. The implementation included:
                </p>
                <ul className="space-y-2">
                  {[
              ...
              <div className="bg-emerald-50 rounded-2xl border border-emerald-100 p-8">
                ...
                <p className="text-slate-600 leading-relaxed mb-6">
                  Two years after launching on Scalaro, Finoglyad has become the
                  undisputed leader in Ukrainian financial media:
                </p>
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  {[
                    ...
                    {
                      value: "#1",
                      label: "Google ranking for 'фінансові продукти'",
                    },
                  ].map((m) => (
        ...
        <section className="py-16 bg-white text-center">
          <div className="max-w-2xl mx-auto px-4">
            ...
            <p className="text-slate-600 mb-6">
              We're documenting success stories from 3 more clients. Want to be
              featured? Share your results with us.
            </p>
            <a
              href="mailto:hello@scalaro.io"
              className="inline-flex items-center gap-2 px-6 py-3 bg-indigo-600 text-white font-semibold rounded-xl hover:bg-indigo-700 transition-all text-sm"
            >
